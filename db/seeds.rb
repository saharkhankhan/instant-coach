...
Sport.create(name: "Swimming 🏊‍♂️")
Sport.create(name: "Running 🏃🏻‍♂️")
Sport.create(name: "HITT 🥊")
Sport.create(name: "Weights 🏋🏼‍♂️")
Sport.create(name: "Yoga 🧘🏼‍♀️")
Sport.create(name: "Karate 🥋")
Sport.create(name: "Spin 🚴🏻‍♂️")
